...
public class Cliente extends JFrame {
    ...
    private static final int CHUNK_SIZE = 768; // Tamaño de trozo más pequeño para UDP
    ...
    private void handleAudioChunk(String message) {
        ...
        try {
            ...
            if (buffer.isComplete()) {
                ...
                String audioMessageText = isMyOwnAudio ? "Audio enviado" : "▶️ Mensaje de voz de " + user;
